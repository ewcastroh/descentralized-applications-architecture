...
export default function AddDish() {
  ...
  const addDish = async () => {
    ...
    if(ethereum) {
        ...
        const contract = new ethers.Contract(abiEimerFoodAddress, EimerFood.abi, signer);
        const transaction = await contract.addEimerFood(formInput.fileUrl, formInput.name, formInput.originCountry);
        transaction.wait();
        router.push('/');
    }
